...
<template>
    <section class="bg-white border-b py-8" id="acting">
        <div class="container mx-auto flex flex-wrap pt-4 pb-12">
            ...
            <div class="w-full md:w-1/4 p-6 flex flex-col flex-grow flex-shrink">
                <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-xl shadow-[#DCBD85]">
                    <a href="#" class="flex flex-wrap no-underline hover:no-underline mt-5">
                        <p class="w-full text-gray-600 text-xs md:text-sm px-6 flex justify-center">
