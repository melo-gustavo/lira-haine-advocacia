            ...
            <div class="flex flex-col justify-around sm:flex-row pt-12 my-12 sm:my-4" id="cards-our-team">
                <div class="max-w-sm rounded overflow-hidden shadow-xl shadow-[#DCBD85] px-12">
                    ...
                    <div class="px-6 pt-4 pb-2 flex justify-center">
                        <span
                            class="inline-block bg-[#DCBD85] rounded-full px-2 py-2 text-sm font-semibold text-gray-700 mr-2 mb-2 shadow-lg shadow-[#DCBD85]">
                            <a href="https://www.instagram.com/direitoempauta_eh/" target="_blank">
                                <img src="/img/instagram.svg" alt="Instagram" class="w-7 h-7">
                            </a>
                        </span>
                        <span
                            class="inline-block bg-[#DCBD85] rounded-full px-2 py-2 text-sm font-semibold text-gray-700 mr-2 mb-2 shadow-lg shadow-[#DCBD85]">
                            <a href="https://www.linkedin.com/in/emillyhaine/" target="_blank">
                                <img src="/img/linkedin.svg" alt="LinkedIn" class="w-7 h-7">
                            </a>
                        </span>
                    </div>
                </div>
                <div class="max-w-sm rounded overflow-hidden shadow-xl shadow-[#DCBD85] px-10" id="card-two-team">
                    ...
                    <div class="px-6 pt-4 pb-2 flex justify-center">
                        <span
                            class="inline-block bg-[#DCBD85] rounded-full px-2 py-2 text-sm font-semibold text-gray-700 mr-2 mb-2 shadow-lg shadow-[#DCBD85]">
                            <a href="https://www.instagram.com/adv.jaquelliras/" target="_blank">
                                <img src="/img/instagram.svg" alt="Instagram" class="w-7 h-7">
                            </a>
                        </span>
                        <span
